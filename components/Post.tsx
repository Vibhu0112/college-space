...
, [db, id]);
    ...
    return (
        <div className="bg-white mx-10 my-7 border rounded-sm">
            ...
            {/*image */}
             <img src={img} className="onject-cover w-full h-full" alt="" />
            ...
            {session && (
                  ...
                  <div className="flex space-x-4">
                     ...
                     {/* <ChatIcon onClick={() => setComment}   className="btn"/>*/}
            ...
            {session && (
                 ...
                 onClick={sendComment}
                 className="font-semibold text-blue-600 ">Post</button>
             </form>  
            )}
                  </div>
    )
